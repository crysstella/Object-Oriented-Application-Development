...
/**
 * Bulbasaur pokemon type Grass has special attacks: vine whip, razor leaf, 
 * and solar beam.
 *
...
public class Bulbasaur extends Pokemon implements Grass {
  ...
  /**
   * Constructor.
   * Creating a new pokemon Bulbasaur: name, hp, and max Hp.
   */
	public Bulbasaur() {
		super("Bulbasaur");
	}
  ...
  /**
   * Generate random damage for vine whip attacks and 
  ...
  /**
   * Generate random damage for razor leaf attacks and 
  ...
  /**
   * Generate random damage for solar beam attacks and 
  ...
  public String solarBeam(Pokemon p){
    int damage = (int)(GenerateRandom.genIntBtw(0, 5)*battleTable[2][p.getType()]);
		p.takeDamage(damage);
